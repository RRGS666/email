...
public class EmailSendUtil {
    ...
    private final static String formName = "wsjkcxs@foxmail.com";//你的邮箱
    private final static String password = "hwnfrzzzgoigbhab"; //授权码
    private final static String replayAddress = "wsjkcxs@foxmail.com"; //你的邮箱


    public static void sendHtmlMail(EmailMailInfo info)throws Exception{
        info.setHost(host);
        info.setFormName(formName);
        info.setFormPassword(password); hwnfrzzzgoigbhab  //网易邮箱的授权码~不一定是密码
    ...
    private static Message getMessage(EmailMailInfo info) throws Exception{
        ...
        //消息的发送者
        message.setFrom(new InternetAddress(p.getProperty("mail.smtp.user"),"我是极客陈先生"));
